                    ...
                    <tr key={dep.DepartmentId}>
                        ...
                        <ButtonToolbar>
                            <Button className='me-2 !important' variant="info" onClick={()=>this.setState({editModalShow:true,
                                 depid:dep.DepartmentId, depname:dep.DepartmentName})}>Edit</Button>
                            <Button className='me-2 !important' variant="danger" onClick={()=>this.deleteDep(dep.DepartmentId)}>Delete</Button>
                        </ButtonToolbar>
                        </td>
                        </tr>)}
               </tbody>
