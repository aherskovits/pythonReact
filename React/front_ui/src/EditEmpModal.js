            ...
            <div className="container">
                <Modal {...this.props} size='lg' aria-labelledby="contained-modal-title-vcenter" centered>
                    <Modal.Header closeButton >
                        <ModalTitle id="contained-modal-title-vcenter">Edit Employee</ModalTitle>
                        </Modal.Header>
                        <Modal.Body>
                            <Row>
                                <Col sm={6}>
                                    <Form onSubmit={this.handleSubmit}>
                                        <Form.Group controlId="EmployeeId">
                                            <Form.Label>EmployeeId </Form.Label>
                                                ...
                                                disabled defaultValue={this.props.empid} placeholder='EmployeeId'/>
                                        </Form.Group>

                                        <Form.Group controlId="EmployeeName">
                                            <Form.Label>EmployeeName </Form.Label>
                                                <Form.Control type='text' name='EmployeeName' required 
                                                defaultValue={this.props.empname} placeholder='EmployeeName'/>
                                            </Form.Group>
                                        ...
                                        <Form.Group controlId="DateOfJoin">
                                            <Form.Label>DateOfJoin</Form.Label>
                                                <Form.Control type="date" name="DateOfJoin" defaultValue={this.props.doj} required placeholder='01-01-2022'/>
                                        </Form.Group>
                                ...
                                <Col sm={6}>
                                    <Image width={'200px'} height={'200px'} src={process.env.REACT_APP_PHOTOPATH+this.props.imagefilename}/>
